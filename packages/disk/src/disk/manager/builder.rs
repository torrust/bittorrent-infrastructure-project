...
impl DiskManagerBuilder {
    ...
    #[must_use]
    pub const fn with_thread_pool_size(mut self, size: usize) -> Self {
    ...
    #[must_use]
    pub const fn with_sink_buffer_capacity(mut self, size: usize) -> Self {
    ...
    #[must_use]
    pub const fn with_stream_buffer_capacity(mut self, size: usize) -> Self {
