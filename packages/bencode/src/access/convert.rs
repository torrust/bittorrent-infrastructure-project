...
pub trait BConvertExt: BConvert {
    ...
    where
        ...
        E: AsRef<[u8]>,
    {
        bencode.bytes_ext().ok_or_else(|| {
            self.handle_error(BencodeConvertError::WrongType {
