---
name: review-pr
description: Review an existing pull request for this project. Covers checklist-based PR quality verification, code style standards, test requirements, documentation, and review feedback. Use only when a PR already exists.
metadata:
  author: torrust
  version: "1.0"
---
